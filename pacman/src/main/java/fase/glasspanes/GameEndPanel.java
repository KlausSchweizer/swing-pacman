...
public class GameEndPanel extends javax.swing.JPanel {
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addContainerGap()
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								...
								.addComponent(botoesPN, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
						.addContainerGap()));
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addGap(50, 50, 50)
						.addComponent(gameOverLB, javax.swing.GroupLayout.PREFERRED_SIZE, 127,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 102, Short.MAX_VALUE)
						.addComponent(botoesPN, javax.swing.GroupLayout.PREFERRED_SIZE,
	...
	private void reiniciarBT1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_reiniciarBT1ActionPerformed
		...
		game.setPontos(0);
		if (game.getPanel() != null) {
			for (Component c : game.getPanel().getComponents()) {
				if (c instanceof JLabel label) {
					String text = label.getText();
					if (text.startsWith("Vidas")) {
						label.setText("Vidas: " + game.getPacman().getVidas());
					} else if (text.startsWith("Pontos")) {
					
						label.setText("Pontos: " + 0);  
					}
				}
			}
		}
