...
public class TransformarTileFantasma extends ImagemTile {
    
    public TransformarTileFantasma(int i, int j){
        super(i, j);
    ...
    int i = 0;
    int j = 0;
    TransformarTileFantasma transformarTileFantasma = new TransformarTileFantasma(i, j);
    List<Direcao> direcoesParede = transformarTileFantasma.verificarDirecoes.executar(ImagemTile.textoMapa, i, j);
    
    new TransformarTileFantasma(i, j).executar(direcoesParede , i, j);
    }
